...
typedef struct{
__REG32 CAP0C0EN_RE : 1;
__REG32 CAP0C0EN_FE : 1;
__REG32 CAP1C0EN_RE : 1;
__REG32 CAP1C0EN_FE : 1;
__REG32 CAP2C0EN_RE : 1;
__REG32 CAP2C0EN_FE : 1;
__REG32 CAP0C1EN_RE : 1;
__REG32 CAP0C1EN_FE : 1;
__REG32 CAP1C1EN_RE : 1;
__REG32 CAP1C1EN_FE : 1;
__REG32 CAP2C1EN_RE : 1;
__REG32 CAP2C1EN_FE : 1;
__REG32 CAP0C2EN_RE : 1;
__REG32 CAP0C2EN_FE : 1;
__REG32 CAP1C2EN_RE : 1;
__REG32 CAP1C2EN_FE : 1;
__REG32 CAP2C2EN_RE : 1;
__REG32 CAP2C2EN_FE : 1;
__REG32 RT0         : 1;
__REG32 RT1         : 1;
__REG32 RT2         : 1;
__REG32 HNFCAP0     : 1;
...
typedef struct{
__REG32 TIM0CAP0_RE : 1;
__REG32 TIM0CAP0_FE : 1;
__REG32 TIM0CAP1_RE : 1;
__REG32 TIM0CAP1_FE : 1;
__REG32 TIM0CAP2_RE : 1;
__REG32 TIM0CAP2_FE : 1;
__REG32 TIM1CAP0_RE : 1;
__REG32 TIM1CAP0_FE : 1;
__REG32 TIM1CAP1_RE : 1;
__REG32 TIM1CAP1_FE : 1;
__REG32 TIM1CAP2_RE : 1;
__REG32 TIM1CAP2_FE : 1;
__REG32 TIM2CAP0_RE : 1;
__REG32 TIM2CAP0_FE : 1;
__REG32 TIM2CAP1_RE : 1;
__REG32 TIM2CAP1_FE : 1;
__REG32 TIM2CAP2_RE : 1;
__REG32 TIM2CAP2_FE : 1;
__REG32             :11;
__REG32 COUNTMODE_C0: 1;
__REG32 COUNTMODE_C1: 1;
__REG32 COUNTMODE_C2: 1;
} __mccntcon_bits;
...
typedef struct{
__REG32 CCP_PWM_A0  : 1;
__REG32 CCP_PWM_B0  : 1;
__REG32 CCP_PWM_A1  : 1;
__REG32 CCP_PWM_B1  : 1;
__REG32 CCP_PWM_A2  : 1;
__REG32 CCP_PWM_B2  : 1;
__REG32             :26;
} __mcccp_bits;
...
__IO_REG32_BIT(STCTRL,                0xE000E010,__READ_WRITE ,__systickcsr_bits);
__IO_REG32_BIT(STRELOAD,              0xE000E014,__READ_WRITE ,__systickrvr_bits);
__IO_REG32_BIT(STCURR,                0xE000E018,__READ_WRITE ,__systickcvr_bits);
__IO_REG32_BIT(STCALIB,               0xE000E01C,__READ       ,__systickcalvr_bits);
...
**                                    ETHERNET
********************************************************************************************************/
__IO_REG32_BIT(MAC_MAC1,                  0x50000000,__READ_WRITE ,__mac1_bits);
__IO_REG32_BIT(MAC_MAC2,                  0x50000004,__READ_WRITE ,__mac2_bits);
__IO_REG32_BIT(MAC_IPGT,                  0x50000008,__READ_WRITE ,__ipgt_bits);
__IO_REG32_BIT(MAC_IPGR,                  0x5000000C,__READ_WRITE ,__ipgr_bits);
__IO_REG32_BIT(MAC_CLRT,                  0x50000010,__READ_WRITE ,__clrt_bits);
__IO_REG32_BIT(MAC_MAXF,                  0x50000014,__READ_WRITE ,__maxf_bits);
__IO_REG32_BIT(MAC_SUPP,                  0x50000018,__READ_WRITE ,__supp_bits);
__IO_REG32_BIT(MAC_TEST,                  0x5000001C,__READ_WRITE ,__test_bits);
__IO_REG32_BIT(MAC_MCFG,                  0x50000020,__READ_WRITE ,__mcfg_bits);
__IO_REG32_BIT(MAC_MCMD,                  0x50000024,__READ_WRITE ,__mcmd_bits);
__IO_REG32_BIT(MAC_MADR,                  0x50000028,__READ_WRITE ,__madr_bits);
__IO_REG32_BIT(MAC_MWTD,                  0x5000002C,__WRITE      ,__mwtd_bits);
__IO_REG32_BIT(MAC_MRDD,                  0x50000030,__READ       ,__mrdd_bits);
__IO_REG32_BIT(MAC_MIND,                  0x50000034,__READ       ,__mind_bits);
__IO_REG32_BIT(MAC_SA0,                   0x50000040,__READ_WRITE ,__sa0_bits);
__IO_REG32_BIT(MAC_SA1,                   0x50000044,__READ_WRITE ,__sa1_bits);
__IO_REG32_BIT(MAC_SA2,                   0x50000048,__READ_WRITE ,__sa2_bits);
__IO_REG32_BIT(MAC_COMMAND,               0x50000100,__READ_WRITE ,__command_bits);
__IO_REG32_BIT(MAC_Status,                0x50000104,__READ       ,__status_bits);
__IO_REG32(    MAC_RXDESCRIPTOR,          0x50000108,__READ_WRITE );
__IO_REG32(    MAC_RXSTATUS,              0x5000010C,__READ_WRITE );
__IO_REG32_BIT(MAC_RXDESCRIPTORNUM,    0x50000110,__READ_WRITE ,__rxdescrn_bits);
__IO_REG32_BIT(MAC_RXPRODUCEINDEX,        0x50000114,__READ       ,__rxprodind_bits);
__IO_REG32_BIT(MAC_RXCONSUMEINDEX,        0x50000118,__READ_WRITE ,__rxcomind_bits);
__IO_REG32(    MAC_TXDESCRIPTOR,          0x5000011C,__READ_WRITE );
__IO_REG32(    MAC_TXSTATUS,              0x50000120,__READ_WRITE );
__IO_REG32_BIT(MAC_TXDESCRIPTORNUM,       0x50000124,__READ_WRITE ,__txdescrn_bits);
__IO_REG32_BIT(MAC_TXPRODUCEINDEX,        0x50000128,__READ_WRITE ,__txprodind_bits);
__IO_REG32_BIT(MAC_TXCONSUMEINDEX,        0x5000012C,__READ       ,__txcomind_bits);
__IO_REG32_BIT(MAC_TSV0,                  0x50000158,__READ       ,__tsv0_bits);
__IO_REG32_BIT(MAC_TSV1,                  0x5000015C,__READ       ,__tsv1_bits);
__IO_REG32_BIT(MAC_RSV,                   0x50000160,__READ       ,__rsv_bits);
__IO_REG32_BIT(MAC_FlowControlCounter,    0x50000170,__READ_WRITE ,__fwctrlcnt_bits);
__IO_REG32_BIT(MAC_FlowControlStatus,     0x50000174,__READ       ,__fwctrlstat_bits);
__IO_REG32_BIT(MAC_RXFILTERCTRL,          0x50000200,__READ_WRITE ,__rxflctrl_bits);
__IO_REG32_BIT(MAC_RxFilterWoLStatus,     0x50000204,__READ_WRITE ,__rxflwolstat_bits);
__IO_REG32_BIT(MAC_RxFilterWoLClear,      0x50000208,__READ_WRITE ,__rxflwolclr_bits);
__IO_REG32(    MAC_HashFilterL,           0x50000210,__READ_WRITE );
__IO_REG32(    MAC_HashFilterH,           0x50000214,__READ_WRITE );
__IO_REG32_BIT(MAC_INTSTATUS,             0x50000FE0,__READ       ,__intstat_bits);
__IO_REG32_BIT(MAC_INTENABLE,             0x50000FE4,__READ_WRITE ,__intena_bits);
__IO_REG32_BIT(MAC_INTCLEAR,              0x50000FE8,__WRITE      ,__intclr_bits);
__IO_REG32_BIT(MAC_IntSet,                0x50000FEC,__WRITE      ,__intset_bits);
__IO_REG32_BIT(MAC_PowerDown,             0x50000FF4,__READ_WRITE ,__pwrdn_bits);
...
__IO_REG32_BIT(USBIntSt,              0x400FC1C0,__READ_WRITE ,__usbints_bits);
...
__IO_REG32_BIT(USBEpInd,              0x5000C248,__WRITE      ,__usbepin_bits);
...
__IO_REG32(    USBTxData,             0x5000C21C,__WRITE);
...
__IO_REG32(    Module_ID,             0x5000C0FC,__READ);
...
__IO_REG32_BIT(U0FIFOLVL,             0x4000C058,__READ_WRITE ,__uartfifolvl_bits);
...
__IO_REG32_BIT(U1FIFOLVL,             0x40010058,__READ_WRITE ,__uartfifolvl_bits);
...
__IO_REG32_BIT(U2FIFOLVL,             0x40098058,__READ_WRITE ,__uartfifolvl_bits);
...
__IO_REG32_BIT(U3FIFOLVL,             0x4009C058,__READ_WRITE ,__uartfifolvl_bits);
...
__IO_REG32(    PWM1CR0,               0x4001802C,__READ_WRITE);
__IO_REG32(    PWM1CR1,               0x40018030,__READ_WRITE);
...
__IO_REG32_BIT(MCDT,                  0x400B803C,__READ_WRITE ,__mcdeadtime_bits);
__IO_REG32_BIT(MCCP,                  0x400B8040,__READ_WRITE ,__mcccp_bits);
__IO_REG32(    MCCR0,                 0x400B8044,__READ_WRITE );
__IO_REG32(    MCCR1,                 0x400B8048,__READ_WRITE );
__IO_REG32(    MCCR2,                 0x400B804C,__READ_WRITE );
...
__IO_REG32_BIT(MCINTFLAG,             0x400B8068,__READ       ,__mcinten_bits);
__IO_REG32_BIT(MCINTFLAG_SET,         0x400B806C,__WRITE      ,__mcinten_bits);
__IO_REG32_BIT(MCINTFLAG_CLR,         0x400B8070,__WRITE      ,__mcinten_bits);
...
//__IO_REG32_BIT(RTCWAKEUPDIS,          0x40024058,__READ_WRITE ,__wakeupdis_bits);
//__IO_REG32_BIT(RTCPWRCTRL,            0x4002405C,__READ_WRITE ,__pwrctrl_bits);
...
__IO_REG8_BIT(RTC_AUX,                0x4002405c,__READ_WRITE ,__rtc_oscf_bit);
__IO_REG8_BIT(RTC_AUXEN,              0x40024058,__READ_WRITE ,__rtc_oscfen_bit);
...
**                                  GPDMA
********************************************************************************************************/
__IO_REG32_BIT(DMACIntStat,           0x50004000,__READ      ,__dmacintstatus_bits);
__IO_REG32_BIT(DMACIntTCStat,         0x50004004,__READ      ,__dmacinttcstatus_bits);
...
__IO_REG32_BIT(DMACRawIntTCStat,      0x50004014,__READ      ,__dmacrawinttcstatus_bits);
__IO_REG32_BIT(DMACRawIntErrStat,     0x50004018,__READ      ,__dmacrawinterrorstatus_bits);
...
__IO_REG32_BIT(DMACConfig,            0x50004030,__READ_WRITE,__dmacconfig_bits);
