...
#define    P0_25_FNUC            P0_25_AD02 // 24V 输入测量；
...
#define    P0_26_FNUC            P0_26_AOUT //P0_26_AOUT    
...
#define    P0_29_USB_D_P         0x01                                   /* USB双向数据D+线              */
//..       Reserved              0x02                                   /* 保留                         */
//..       Reserved              0x03                                   /* 保留                         */
...
#define    P0_30_USB_D_N         0x01                                   /* USB双向数据D-线              */
//..       Reserved              0x02                                   /* 保留                         */
//..       Reserved              0x03                                   /* 保留                         */
...
#define    P0_10_MODE        PIN_NO_PULL	// I2C2
#define    P0_11_MODE        PIN_NO_PULL	// I2C2
...
#define    P0_19_MODE        PIN_NO_PULL	// I2C1
#define    P0_20_MODE        PIN_NO_PULL	// I2C1
#define    P0_21_MODE        PIN_PULL_UP
#define    P0_22_MODE        PIN_PULL_UP
#define    P0_23_MODE        PIN_NO_PULL	// AD0
#define    P0_24_MODE        PIN_NO_PULL	// AD1
#define    P0_25_MODE        PIN_NO_PULL	// AD2
#define    P0_26_MODE        PIN_NO_PULL	//DAC PIN_PULL_UP
#define    P0_27_MODE        PIN_NO_PULL	// I2C0
#define    P0_28_MODE        PIN_NO_PULL	// I2C0
#define    P0_29_MODE        PIN_PULL_UP
#define    P0_30_MODE        PIN_PULL_UP
#define    P0_31_MODE        PIN_PULL_UP

//P1
#define    P1_0_MODE         PIN_NO_PULL // PIN_PULL_UP
#define    P1_1_MODE         PIN_NO_PULL // PIN_PULL_UP
#define    P1_2_MODE         PIN_NO_PULL // PIN_PULL_UP
#define    P1_3_MODE         PIN_NO_PULL // PIN_PULL_UP
#define    P1_4_MODE         PIN_PULL_UP // PIN_NO_PULL // PIN_PULL_UP
#define    P1_5_MODE         PIN_NO_PULL // PIN_PULL_UP
#define    P1_6_MODE         PIN_NO_PULL // PIN_PULL_UP
#define    P1_7_MODE         PIN_NO_PULL // PIN_PULL_UP 
#define    P1_8_MODE         PIN_PULL_UP // PIN_NO_PULL // PIN_PULL_UP
#define    P1_9_MODE         PIN_NO_PULL // PIN_PULL_UP
#define    P1_10_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_11_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_12_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_13_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_14_MODE        PIN_PULL_UP // PIN_NO_PULL // PIN_PULL_UP
#define    P1_15_MODE        PIN_PULL_UP // PIN_NO_PULL // PIN_PULL_UP
#define    P1_16_MODE        PIN_PULL_UP
#define    P1_17_MODE        PIN_PULL_UP    
#define    P1_18_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_19_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_20_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_21_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_22_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_23_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_24_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_25_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_26_MODE        PIN_NO_PULL // PIN_PULL_UP
#define    P1_27_MODE        PIN_PULL_UP // PIN_PULL_UP     
#define    P1_28_MODE        PIN_PULL_UP // PIN_PULL_UP     
#define    P1_29_MODE        PIN_NO_PULL // PIN_PULL_UP     
#define    P1_30_MODE        PIN_NO_PULL // PIN_PULL_UP     
#define    P1_31_MODE        PIN_NO_PULL // PIN_PULL_UP     
...
#define    P4_29_MODE        PIN_NO_PULL // PIN_PULL_UP     
